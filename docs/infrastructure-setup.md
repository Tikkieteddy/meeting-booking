...
### 2.4.0 เติมรายการสิ่งอำนวยความสะดวกมาตรฐาน (ทำครั้งเดียวหลังตั้งระบบ)

ฐานข้อมูลที่ตั้งด้วย bootstrap รุ่นเก่า (ก่อน 22 ก.ย. 2569) จะไม่มีรายการ
สิ่งอำนวยความสะดวกให้ติ๊กตอนเพิ่มห้อง — เติมได้โดยเปิด GitHub →
`db/upgrades/reference-amenities.sql` → **Raw** → คัดลอก → Neon **SQL Editor** → **Run**

**ถ้าสำเร็จจะเห็น:** แถวเดียว `amenities` = 8 และ `result` = **ผ่าน** (รันซ้ำได้ ไม่ซ้ำ)

ส่วน **อาคาร** ไม่ต้องใช้ SQL — เพิ่มได้จากหน้าเว็บ: ผู้ดูแลระบบ → จัดการห้อง → ส่วน "อาคาร" → **เพิ่มอาคาร**
