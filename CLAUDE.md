...
## กฎข้อแรก — รายงานความคืบหน้าเป็นภาษาคน

**คนที่อ่านรายงานเขียนโค้ดไม่เป็น** เขียนให้เขาเข้าใจและตัดสินใจได้
ไม่ใช่เขียนให้ตัวเองเข้าใจ ถ้าเขาอ่านจบแล้วยังไม่รู้ว่าเกิดอะไรขึ้นหรือต้องทำอะไรต่อ
รายงานนั้นถือว่าใช้ไม่ได้ ไม่ว่าจะถูกต้องแค่ไหน

**ต้องทำ**

- **บอกผลก่อน แล้วค่อยบอกวิธี** — พูดว่า "จองห้องซ้อนกันไม่ได้แล้ว"
  ก่อนจะพูดว่า "เพิ่ม exclusion constraint บนฐานข้อมูล"
- **ศัพท์เทคนิคต้องแปลครั้งแรกที่ใช้** — เขียน "ระบบกันไม่ให้คนอื่นเห็นข้อมูลที่ไม่ใช่ของตัวเอง
  ที่ชั้นฐานข้อมูล (RLS)" ไม่ใช่โปรย "RLS" ลอย ๆ
- **ปิดท้ายด้วยสิ่งที่ผู้ใช้ต้องทำต่อ** และบอกว่าจะรู้ได้อย่างไรว่าสำเร็จหรือพัง
- **ตัวเลขต้องมาจากการวัดจริง** ถ้าเดาให้บอกว่าเดา ถ้าเคยบอกผิดให้แก้ให้ชัด
- **สิ่งที่ยังไม่เสร็จ พลาดไป หรือขัดแย้งกันเอง ต้องบอกตรง ๆ** ไม่กลบด้วยรายละเอียดที่ดูดี
- ถ้าต้องให้ผู้ใช้กดอะไร ให้บอกครบ: **กดที่ไหน / ปุ่มชื่ออะไร / พิมพ์อะไร /
  สำเร็จแล้วจะเห็นอะไร / ถ้าพังให้ทำอะไร**

**ห้ามทำ**

- ไล่ชื่อไฟล์ ชื่อฟังก์ชัน ชื่อไลบรารี เป็นพรืด โดยไม่บอกว่ามันทำอะไรให้ผู้ใช้
- รายงานว่า "เสร็จแล้ว" โดยไม่บอกว่าทดสอบอย่างไรและผลออกมาเป็นอะไร
- เขียนยาวเพราะทำงานมาเยอะ — ความยาวต้องมาจากสิ่งที่ผู้อ่านต้องรู้ ไม่ใช่สิ่งที่เราทำ

**รายละเอียดเชิงเทคนิคไม่ได้หายไป** — ย้ายไปอยู่ใน `docs/`, คอมเมนต์ในโค้ด
และข้อความ commit ส่วนข้อความที่ตอบผู้ใช้ในแชตให้เป็นภาษาคน

**ข้อยกเว้น** ถ้าผู้ใช้ถามเชิงเทคนิคตรง ๆ ("ใช้ pooler โหมดไหน") ก็ตอบเชิงเทคนิคได้เต็มที่
กฎนี้ใช้กับ*การรายงานความคืบหน้า* ไม่ใช่การห้ามคุยเรื่องเทคนิค
